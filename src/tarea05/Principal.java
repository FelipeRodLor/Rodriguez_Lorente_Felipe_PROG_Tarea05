...
public class Principal {
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            /*
        Crea una clase llamada Principal que incluya un método main. El método main deberá mostrarnos un menú con las diferentes
        opciones (añadir cliente, borrar cliente, listar clientes, añadir turismo, borrar turismo, listar turismos, abrir un alquiler,
        cerrar un alquiler, listar alquileres y salir)
             */
        } while (opcion
                != 10);
        System.out.println(
